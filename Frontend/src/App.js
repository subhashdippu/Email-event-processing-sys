  ...
  return (
    <div className="h-screen w-full bg-white flex font-sans">
      ...
      <aside className="w-64 border-r px-4 py-5 flex flex-col">
        <div className="text-2xl font-bold mb-6">ONG</div>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="text-sm">
            <div className="font-semibold">Oliver Brown</div>
            <div className="text-gray-400">oliver.brown@domain.io</div>
          </div>
        </div>

        <button className="mb-6 rounded-full border border-green-500 text-green-600 py-2 font-medium">
          Compose
        </button>
